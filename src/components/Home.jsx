  ...
  return (
    <section className="relative h-screen flex items-center justify-center text-center overflow-hidden">
      ...
      >
        ...
        >
          “We merge <span className="font-semibold text-green-400">Faith</span> and <span className="font-semibold text-green-400">Technology</span> to help you inspire, innovate, and impact the world.”
        </motion.blockquote>
